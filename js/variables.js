...
var map_color = "#b59f8a";                      //Google map color
var map_initial_zoom = 12;                      //The initial zoom when Google map loads
var map_initial_latitude = 23.90;           //Google map initial Latitude. If "null", the latitude of the first marked will be used
var map_initial_longitude = 73.32;        //Google map initial Longitude. If "null", the longitude of the first marked will be used
...
var map_markers = [
    {
        ...
        "latitude": 23.839162,
        "longitude": 73.287260,
        "icon": "fas fa-chess-king", //Check the full list of icons at http://fortawesome.github.io/Font-Awesome/icons/
        "infoWindow": "At Po. Kanadar, Vijaynagar, Sabarkantha"
    },
   
    {
        ...
        "latitude": 23.928312,
        "longitude": 73.343337,
        "icon": "fas fa-chess-queen", //Check the full list of icons at http://fortawesome.github.io/Font-Awesome/icons/
        "infoWindow": "At Po. Biladiya, Vijaynagar, Sabarkantha"
    }
];